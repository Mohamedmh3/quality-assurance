...
export const editProfileTestCases: TestCase[] = [
 {
  ...
  testSteps: [
   {
    step: 1,
    instruction: 'Go to edit profile screen',
    detailedSteps: [
     '1. Open app',
   ...
   {
    step: 2,
    instruction: 'Verify loyalty element is displayed',
    detailedSteps: [
     '1. Check if loyalty element appears',
     '2. Check welcome message',
     '3. Check points display',
    ],
    whatYouShouldSee: 'Loyalty element appears at top showing "Welcome [User Name]", circular progress indicator with mascot image in center, current points (e.g., "100 pt"), and points remaining to next tier if applicable',
    expectedResult: 'Loyalty element is displayed correctly',
   },
   {
    step: 3,
  ...
  preconditions: [
   'User is logged in',
   'User goes to edit profile screen',
 ...
 },
 {
  ...
  automatable: true,
  status: 'Not Started',
  notes: 'Gender is fetched from server',
  successChecklist: [
 ...
 },
 {
  ...
  automatable: true,
  status: 'Not Started',
  notes: 'Cities are fetched from server',
  successChecklist: [
 ...
 },
 {
  ...
  testSteps: [
   {
    step: 1,
    instruction: 'View loyalty element',
    detailedSteps: [
     '1. Go to edit profile screen',
     '2. Observe loyalty element at top',
    ],
    whatYouShouldSee: 'Loyalty element appears showing "Welcome [User Name]" text, circular progress indicator with mascot image in center, current points (e.g., "100 pt"), and points remaining to next tier if applicable',
    expectedResult: 'Loyalty element is displayed',
   },
   {
    step: 2,
  ...
  automatable: true,
  status: 'Not Started',
  notes: 'Loyalty info is fetched from server',
  successChecklist: [
   '✓ Loyalty element appears',
 ...
 },
 {
  ...
  testSteps: [
   ...
   },
   {
    ...
    whatYouShouldSee: 'Loading state appears, form validation occurs, server request is made to update user info',
   ...
   },
   {
    ...
    whatYouShouldSee: 'Loading state disappears, screen closes or navigates back. If from deep link launch, goes to splash. Otherwise, pops go to',
  ...
  automatable: true,
  status: 'Not Started',
  notes: 'go to depends on whether user came from deep link',
  successChecklist: [
   '✓ Save button works',
 ...
 },
 {
  ...
  testSteps: [
   ...
   },
   {
    ...
    whatYouShouldSee: 'Loading state appears, logout server request is made',
  ...
  testSteps: [
   {
    ...
    detailedSteps: [
     '1. Go to edit profile screen on iOS',
   ...
   },
   {
    ...
    whatYouShouldSee: 'Loading state appears, delete account server request is made',
  ...
  testSteps: [
   {
    ...
    expectedResult: 'server requests are initiated',
   },
   {
    step: 2,
    instruction: 'Wait for data to load',
    detailedSteps: [
     '1. Wait for server responses',
    ],
 ...
 {
  id: 'TC-EDIT-PROFILE-014',
  title: 'Handle Logout Error',
  whatYoureTesting: 'Verify that errors during logout are handled gracefully',
  whyItMatters: 'Network errors or server errors should not crash the app. Users should see appropriate error messages.',
  estimatedTime: '2-3 minutes',
  type: 'Functional',
  priority: 'P0',
  ...
  testSteps: [
   {
    step: 1,
    instruction: 'Attempt logout with error',
    detailedSteps: [
     '1. Tap logout button',
     '2. Disable network or simulate error',
    ],
    whatYouShouldSee: 'Loading state appears, then error occurs',
    expectedResult: 'Logout fails',
   },
   {
    step: 2,
    instruction: 'Verify error handling',
    ...
    whatYouShouldSee: 'Error is caught, loading state is cleared. Error message may appear. User remains logged in. User can retry',
    expectedResult: 'Error is handled gracefully',
   },
   {
    step: 3,
    instruction: 'Retry logout',
    detailedSteps: [
     '1. Enable network',
     '2. Tap logout again',
    ],
    whatYouShouldSee: 'Logout retries successfully, user is logged out, navigated to splash',
    expectedResult: 'Retry works correctly',
   },
  ],
  preconditions: [
 ...
 {
  id: 'TC-EDIT-PROFILE-015',
  title: 'Handle Delete Account Error',
  whatYoureTesting: 'Verify that errors during account deletion are handled gracefully',
  whyItMatters: 'Network errors or server errors should not crash the app. Users should see appropriate error messages.',
  estimatedTime: '2-3 minutes',
  type: 'Functional',
  priority: 'P0',
  ...
  testSteps: [
   {
    step: 1,
    instruction: 'Attempt account deletion with error',
    detailedSteps: [
   ...
   },
   {
    ...
    detailedSteps: [
     '1. Observe error state',
     '2. Check if account still exists',
    ],
    whatYouShouldSee: 'Error is caught, loading state is cleared. Error message may appear. Account is not deleted. User can retry',
    expectedResult: 'Error is handled gracefully',
   },
   {
    step: 3,
    instruction: 'Retry deletion',
    detailedSteps: [
     '1. Enable network',
     '2. Tap delete account again',
     '3. Confirm deletion',
    ],
    whatYouShouldSee: 'Deletion retries successfully, account is deleted, baskets are deleted, navigated to splash',
    expectedResult: 'Retry works correctly',
   },
  ],
  preconditions: [
  ...
  successChecklist: [
   '✓ Error is caught',
   '✓ Loading state is cleared',
   '✓ Account is not deleted on error',
   '✓ Retry works',
  ],
 },
 {
  id: 'TC-EDIT-PROFILE-016',
  title: 'Display Error State for Initial Data',
  whatYoureTesting: 'Verify that error state is displayed when initial data fails to load',
  whyItMatters: 'Users need to see error messages and have retry option when data fails to load.',
  estimatedTime: '1-2 minutes',
  type: 'Functional',
  priority: 'P0',
  relatedUseCases: ['UC-EDIT-PROFILE-011'],
  ...
  testSteps: [
   {
    step: 1,
    instruction: 'Go to edit profile screen with network error',
    detailedSteps: [
     '1. Disable network or simulate error',
     '2. Go to edit profile screen',
    ],
    whatYouShouldSee: 'Loading state appears, then error state is displayed',
    expectedResult: 'Error state appears',
   },
   {
    step: 2,
    instruction: 'Verify error element',
    detailedSteps: [
     '1. Check if AppFailureWidget is displayed',
     '2. Check if retry button is available',
    ],
    whatYouShouldSee: 'AppFailureWidget appears showing error message. Retry button is available',
    expectedResult: 'Error element is displayed correctly',
   },
   {
    step: 3,
    instruction: 'Retry loading data',
    detailedSteps: [
     '1. Enable network',
     '2. Tap retry button',
    ],
    whatYouShouldSee: 'Loading state appears again, data is loaded successfully, screen displays normally',
    expectedResult: 'Retry works correctly',
   },
  ],
  preconditions: [
  ...
  automatable: false,
  status: 'Not Started',
  notes: 'AppFailureWidget is shown when getInitialDataState.isError is true',
  successChecklist: [
   '✓ Error state appears',
   '✓ Error element is displayed',
   '✓ Retry button works',
  ],
 },
 {
  id: 'TC-EDIT-PROFILE-017',
  title: 'Mobile Field is Read-Only',
  whatYoureTesting: 'Verify that mobile field is read-only and displays value from UserManager',
  whyItMatters: 'Mobile number should not be editable from profile screen. It should be displayed from UserManager.',
  estimatedTime: '1 minute',
  type: 'Functional',
  priority: 'P1',
  relatedUseCases: ['UC-EDIT-PROFILE-001'],
  relatedEdgeCases: [],
  testSteps: [
   {
    step: 1,
    instruction: 'View mobile field',
    detailedSteps: [
     '1. Go to edit profile screen',
     '2. Find mobile field',
    ],
    whatYouShouldSee: 'Mobile input field appears showing current mobile number from UserManager',
    expectedResult: 'Mobile field is displayed',
   },
   {
    step: 2,
    instruction: 'Try to edit mobile field',
    detailedSteps: [
     '1. Tap on mobile field',
     '2. Try to type or edit',
    ],
    whatYouShouldSee: 'Mobile field is read-only. Field cannot be edited. Keyboard does not appear or field does not accept input',
    expectedResult: 'Mobile field is read-only',
   },
  ],
  preconditions: [
   'Edit profile screen is displayed',
   'Mobile field is visible',
  ],
  testData: 'N/A',
  automatable: true,
  status: 'Not Started',
  notes: 'Mobile field displays UserManager.instance.mobileNumber and is read-only',
  successChecklist: [
   '✓ Mobile field appears',
   '✓ Mobile field is read-only',
   '✓ Mobile number is displayed correctly',
  ],
 },
 {
  id: 'TC-EDIT-PROFILE-018',
  title: 'Handle Null Loyalty Info',
  whatYoureTesting: 'Verify that screen handles null loyalty info gracefully',
  whyItMatters: 'Some users may not have loyalty info. Screen should handle this gracefully.',
  estimatedTime: '1 minute',
  type: 'Functional',
  priority: 'P1',
  relatedUseCases: ['UC-EDIT-PROFILE-007'],
  ...
  testSteps: [
   {
    step: 1,
    instruction: 'Go to edit profile screen with null loyalty info',
    detailedSteps: [
     '1. Use account without loyalty info',
     '2. Go to edit profile screen',
    ],
    whatYouShouldSee: 'Screen loads. If loyaltyInfo is null, empty element (SizedBox) is shown instead of loyalty element',
    expectedResult: 'Screen handles null loyalty info',
   },
   {
    step: 2,
    instruction: 'Verify form is still accessible',
    detailedSteps: [
     '1. Check if form is displayed',
     '2. Check if form fields are accessible',
    ],
    whatYouShouldSee: 'Form is displayed normally. All form fields are accessible. Profile editing works normally',
    expectedResult: 'Form is accessible',
   },
  ],
  preconditions: [
   'User goes to edit profile screen',
   'User has no loyalty info',
  ],
  testData: 'User without loyalty account',
  automatable: true,
  status: 'Not Started',
  notes: 'If loyaltyInfo is null, empty Material element is shown',
  successChecklist: [
   '✓ Screen handles null loyalty info',
   '✓ Form is accessible',
  ],
 },
 {
  id: 'TC-EDIT-PROFILE-019',
  title: 'Prevent Update When UserInfo is Null',
  whatYoureTesting: 'Verify that update is prevented when userInfo is null',
  whyItMatters: 'Update should not proceed if userInfo is null. This prevents errors.',
  estimatedTime: '1 minute',
  type: 'Functional',
  priority: 'P0',
  relatedUseCases: ['UC-EDIT-PROFILE-008'],
  relatedEdgeCases: ['EC-EDIT-PROFILE-015'],
  testSteps: [
   {
    step: 1,
    instruction: 'Attempt update when userInfo is null',
    detailedSteps: [
     '1. Ensure userInfo is null (edge case scenario)',
     '2. Make changes to form',
     '3. Tap Save button',
    ],
    whatYouShouldSee: 'Update does not proceed. No server request is made. Early return occurs',
    expectedResult: 'Update is prevented',
   },
   {
    step: 2,
    instruction: 'Verify no error occurs',
    detailedSteps: [
     '1. Check if app crashes',
     '2. Check if error message appears',
    ],
    whatYouShouldSee: 'No error occurs. App does not crash. Update simply does not proceed',
    expectedResult: 'No error occurs',
   },
  ],
  preconditions: [
   'Edit profile screen is displayed',
   'userInfo is null (edge case)',
  ],
  testData: 'N/A',
  automatable: true,
  status: 'Not Started',
  notes: 'updateUserInfo checks if userInfo is null and returns early if null',
  successChecklist: [
   '✓ Update is prevented',
   '✓ No error occurs',
  ],
