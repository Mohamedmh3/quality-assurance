...
export const menuRestaurantTestCases: TestCase[] = [
 ...
 // ============================================
 {
  ...
  testSteps: [
   ...
   },
   {
    ...
    expectedResult: 'Bottom go to shows Shop and Aisles tabs, Shop is selected by default'
   },
   {
    step: 3,
 ...
 {
  id: 'TC-MENU-REST-004',
  title: 'Market Sub-Categories go to',
 ...
 // ============================================
 {
  ...
  testSteps: [
   {
    ...
    whatYouShouldSee: 'A rewards element showing something like "X left to earn FREE DELIVERY" or reward tiers with progress.',
   ...
   },
   {
    ...
    detailedSteps: [
     '1. Read what the rewards element shows',
   ...
   },
   {
    ...
    detailedSteps: [
     ...
     '2. Go back to view the rewards element',
  ...
  successChecklist: [
   '✓ Rewards element is visible (if restaurant has rewards)',
  ...
  ifThisFails: {
   commonIssues: [
    {
     problem: 'No rewards element visible',
 ...
 },
 {
  ...
  successChecklist: [
   ...
   '✓ go to between categories works'
  ],
  ifThisFails: {
   commonIssues: [
    {
 ...
 // ============================================
 {
  ...
  testSteps: [
   ...
   },
   {
    ...
    expectedResult: 'Back go to through category hierarchy works correctly'
   }
  ],
  successChecklist: [
   ...
   '✓ go to back through levels works smoothly',
