...
export const editProfileTestCases: TestCase[] = [
  ...
  },
  {
    ...
    testSteps: [
      {
        step: 1,
        instruction: 'Navigate to edit profile screen with network error',
        detailedSteps: [
      ...
      {
        step: 2,
        instruction: 'Verify error widget',
        detailedSteps: [
        ...
        expectedResult: 'Error widget is displayed correctly',
      },
      {
        step: 3,
  ...
  },
  {
    ...
    testSteps: [
      {
        step: 1,
        instruction: 'Navigate to edit profile screen with null loyalty info',
        detailedSteps: [
          '1. Use account without loyalty info',
          '2. Navigate to edit profile screen',
        ],
        whatYouShouldSee: 'Screen loads. If loyaltyInfo is null, empty widget (SizedBox) is shown instead of loyalty widget',
    ...
    automatable: true,
    status: 'Not Started',
    notes: 'If loyaltyInfo is null, empty Material widget is shown',
    successChecklist: [
    ...
    testSteps: [
      {
        ...
        whatYouShouldSee: 'Update does not proceed. No API request is made. Early return occurs',
