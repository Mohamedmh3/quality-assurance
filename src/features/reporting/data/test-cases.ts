...
export const reportingTestCases: TestCase[] = [
  {
    ...
    testSteps: [
      {
        step: 1,
        instruction: 'Navigate to report issue screen',
        detailedSteps: [
      ...
      },
      {
        ...
        whatYouShouldSee: 'List of issue types appears. Each issue type shows as a card/widget with its name and reasons. Warning message appears at bottom with "Rate the Order" text',
  ...
  },
  {
    ...
    testSteps: [
      ...
      {
        step: 3,
        instruction: 'Navigate to next step',
        detailedSteps: [
        ...
        expectedResult: 'Navigation to next step works',
      },
      {
        step: 4,
  ...
  },
  {
    ...
    testSteps: [
      {
        step: 1,
        instruction: 'Navigate to reason step with date requirement',
        detailedSteps: [
          '1. Select reason with withDate = true',
          '2. Navigate to that reason step',
        ],
  ...
  },
  {
    ...
    testSteps: [
      {
        step: 1,
        instruction: 'Navigate to reason step with dish search requirement',
        detailedSteps: [
  ...
  },
  {
    ...
    testSteps: [
      {
        step: 1,
        instruction: 'Navigate to reason step with note requirement',
        detailedSteps: [
  ...
  },
  {
    ...
    testSteps: [
      {
        step: 1,
        instruction: 'Navigate to reason step with app name requirement',
        detailedSteps: [
  ...
  },
  {
    ...
    testSteps: [
      ...
      },
      {
        ...
        expectedResult: 'Back navigation works',
      },
      {
        step: 3,
        ...
        whatYouShouldSee: 'Previous data is preserved. Modified data is saved. Navigation forward works',
  ...
  },
  {
    ...
    automatable: true,
    status: 'Not Started',
    notes: 'Success message appears after navigation',
    successChecklist: [
  ...
  },
  {
    ...
    whatYoureTesting: 'Verify that issue types are fetched from API when screen loads',
    ...
    testSteps: [
      {
        step: 1,
        instruction: 'Navigate to report screen',
        detailedSteps: [
          '1. Open restaurant page',
          '2. Tap on report issue option',
        ],
    ...
    preconditions: [
      'User navigates to report screen',
