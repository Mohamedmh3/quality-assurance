...
export const orderRatingTestCases: TestCase[] = [
 {
  ...
  whyItMatters: 'Customers need to rate their orders to help improve . If they cannot open the rating screen, they cannot provide feedback.',
  ...
  testSteps: [
   ...
   },
   {
    ...
    whatYouShouldSee: 'A new screen opens showing: restaurant logo and name at the top, star rating element in the middle, and empty options below',
  ...
  successChecklist: [
   ...
   '✓ Star rating element is visible',
  ...
  testSteps: [
   {
    ...
    detailedSteps: [
     ...
     '2. Look for the star rating element (5 stars in a row)',
    ...
    expectedResult: 'Star rating element is visible and ready',
   },
   {
    step: 2,
   ...
   },
   {
    ...
    detailedSteps: [
     '1. After tapping stars, look below the star element',
 ...
 },
 {
  ...
  whyItMatters: 'Customers need to rate both - go to between tabs must be smooth',
  estimatedTime: '2-3 minutes',
  type: 'Functional',
  priority: 'P1',
  ...
  successChecklist: [
   '✓ Next button goes to driver rating',
