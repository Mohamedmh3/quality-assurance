...
export const liveChatTestCases: TestCase[] = [
 {
  ...
  testSteps: [
   {
    step: 1,
    instruction: 'Go to a screen with live chat button',
    detailedSteps: [
     '1. Open the app',
     '2. Go to profile screen or other screen with live chat enabled',
     '3. Look for floating action button',
    ],
    whatYouShouldSee: 'A floating action button appears at the bottom-right corner of the screen. The button is circular with a chat bubble icon in white color. The button has a subtle bounce animation that moves it up and down continuously.',
 ...
 },
 {
  ...
  whyItMatters: 'Users need to access chat support. go to must work correctly and chat must load.',
  ...
  testSteps: [
   {
    ...
    whatYouShouldSee: 'When you tap the button, the screen changes to show the live chat screen. A bar appears at the top with "Contact Us" title.',
        expectedResult: 'Going to chat screen works',
   },
   {
    step: 2,
    instruction: 'Verify loading state',
    detailedSteps: [
     '1. Observe the screen after tapping the button',
     '2. Check for loading indicator',
    ],
    whatYouShouldSee: 'A loading spinner appears in the center of the screen. This shows that the app is getting the chat link from the server. The loading spinner continues while the app is waiting for the server to respond.',
   ...
   },
   {
    ...
    whatYouShouldSee: 'After loading completes, a chat window appears filling the screen below the top bar. The chat window shows the chat interface from the link the app received. You can see the chat interface with message history, input field, and send button.',
  ...
  automatable: false,
  status: 'Not Started',
  notes: 'Chat link is fetched from the server',
  successChecklist: [
   '✓ go to works',
   '✓ Loading state appears',
   '✓ Chat interface loads',
   '✓ web browser displays correctly',
  ],
 },
 {
  id: 'TC-LIVE-CHAT-003',
  ...
  testSteps: [
   {
    ...
    detailedSteps: [
     ...
     '2. Go to screen with live chat button',
  ...
  testData: 'Unread message count from server',
  automatable: true,
  status: 'Not Started',
  notes: 'Badge appears when there are unread messages and disappears when count is zero',
  successChecklist: [
 ...
 {
  id: 'TC-LIVE-CHAT-004',
  title: 'Open Chat with Order Context',
  whatYoureTesting: 'Verify that live chat can be opened with order information so support can help with a specific order',
  ...
  testSteps: [
   {
    ...
    whatYouShouldSee: 'Live chat button may appear on order details screen. When you tap it, the order number is sent to the chat screen. The screen changes to show chat with order information.',
    expectedResult: 'Chat opens with order information',
   },
   {
    step: 2,
    ...
    whatYouShouldSee: 'Chat interface loads. The chat link may include order information or the support agent may see order details. Order information is available in the chat session.',
  ...
  testData: 'Order number from order',
  automatable: false,
  status: 'Not Started',
  notes: 'Order number is sent when opening chat',
  successChecklist: [
   '✓ Chat opens with order information',
 ...
 {
  id: 'TC-LIVE-CHAT-005',
  title: 'Interact with Chat web browser',
  whatYoureTesting: 'Verify that users can interact with the chat web browser to send and receive messages',
  ...
  testSteps: [
   {
    ...
    detailedSteps: [
     '1. Open live chat',
     '2. Wait for web browser to load',
     '3. Check chat interface',
    ],
    whatYouShouldSee: 'Chat window displays the chat interface. You can see message history, input field, send button, and other chat controls. The interface is fully interactive.',
  ...
  automatable: false,
  status: 'Not Started',
  notes: 'Chat functionality depends on the web browser and external chat ',
  successChecklist: [
 ...
 },
 {
  ...
  whyItMatters: 'Users need to return to previous screen after chat. go to must work correctly.',
  ...
  testSteps: [
   {
    ...
    whatYouShouldSee: 'When you tap the back button (arrow icon) at the top, you go back to the previous screen. Chat session may remain active in the background.',
    expectedResult: 'go to back works',
   },
   {
    step: 2,
  ...
  automatable: true,
  status: 'Not Started',
  notes: 'Back button returns to previous screen',
  successChecklist: [
   '✓ Back button works',
 ...
 },
 {
  ...
  whatYoureTesting: 'Verify that loading indicator is displayed while chat link is being fetched',
  ...
  testSteps: [
   {
    ...
    whatYouShouldSee: 'Chat screen appears with top bar showing "Contact Us" title. In the middle of the screen, a loading spinner appears. Loading indicator shows that the app is getting the chat link.',
    expectedResult: 'Loading state is displayed',
   },
   {
    step: 2,
    ...
    whatYouShouldSee: 'Loading spinner continues to spin while the app is waiting for the server. Once the server responds with the chat link, loading stops and chat interface appears.',
   ...
   },
   {
    ...
    whatYouShouldSee: 'Loading spinner disappears smoothly. Chat window fades in showing the chat interface. The transition is smooth without flickering.',
  ...
  automatable: false,
  status: 'Not Started',
  notes: 'Loading state shows while app is getting chat link',
  successChecklist: [
 ...
 {
  id: 'TC-LIVE-CHAT-008',
  title: 'Handle Chat link Fetch Error',
  whatYoureTesting: 'Verify that error message is displayed when chat link cannot be fetched',
  ...
  testSteps: [
   {
    step: 1,
    instruction: 'Simulate connection error',
    detailedSteps: [
     '1. Disable network or disconnect from internet',
   ...
   },
   {
    ...
    whatYouShouldSee: 'An error message appears centered on screen. A sad mascot image is displayed. Below the image, error text "Something went wrong" is shown. The error is clearly visible.',
   ...
   },
   {
    ...
    whatYouShouldSee: 'After fixing the issue and reopening chat, loading appears again. Chat link is fetched successfully and chat interface loads.',
    expectedResult: 'Retry works correctly',
   },
  ],
  preconditions: [
   'Live chat is enabled',
   'Network can be disabled or connection can fail',
  ],
  testData: 'N/A',
  automatable: false,
  status: 'Not Started',
  notes: 'Error occurs when chat link cannot be fetched',
  successChecklist: [
   '✓ Error state appears',
 ...
 },
 {
  ...
  testSteps: [
   {
    ...
    detailedSteps: [
     '1. Go to screen with live chat button',
     '2. Watch the button',
    ],
    whatYouShouldSee: 'Live chat button continuously animates with a bounce effect. Button moves up and down. Animation repeats continuously with about 1 second per bounce.',
   ...
   },
   {
    ...
    whatYouShouldSee: 'When you go to another screen, animation stops properly.',
  ...
  automatable: false,
  status: 'Not Started',
  notes: 'Animation repeats continuously while button is visible',
  successChecklist: [
 ...
 },
 {
  ...
  testSteps: [
   {
    ...
    whatYouShouldSee: 'Tutorial is set up to highlight live chat button. Tutorial can be shown when user first sees the button.',
  ...
  automatable: false,
  status: 'Not Started',
  notes: 'Tutorial can be enabled for the chat button',
  successChecklist: [
 ...
 {
  id: 'TC-LIVE-CHAT-011',
  title: 'Chat Session Fresh Start',
  whatYoureTesting: 'Verify that stored data and login information are cleared when chat loads',
  whyItMatters: 'Clearing old data ensures fresh chat session. This prevents login problems.',
  estimatedTime: '2 minutes',
  type: 'Functional',
  priority: 'P1',
  relatedUseCases: ['UC-LIVE-CHAT-004'],
  ...
  testSteps: [
   {
    ...
    whatYouShouldSee: 'Chat screen loads. Chat window starts fresh. Old stored data and login information are cleared automatically when chat loads.',
    expectedResult: 'Old data is cleared',
   },
   {
    step: 2,
    ...
    whatYouShouldSee: 'Chat interface loads with fresh session. Login works correctly. No old stored data interferes with chat.',
  ...
  automatable: false,
  status: 'Not Started',
  notes: 'Old stored data is cleared when chat loads',
  successChecklist: [
   '✓ Old stored data is cleared',
   '✓ Login information is refreshed',
 ...
 },
 {
  ...
  preconditions: [
   ...
   'User can Go to screens with chat button',
  ],
  testData: 'N/A',
  automatable: true,
  status: 'Not Started',
