...
export const splashTestCases: TestCase[] = [
  ...
  },
  {
    ...
    testSteps: [
      ...
      },
      {
        ...
        expectedResult: 'Intro completed, navigates to next screen'
      },
      {
        step: 4,
      ...
      commonIssues: [
        {
          ...
          technicalNote: 'update_type=2 should block all navigation'
        }
      ]
    },
    ...
    ifThisFails: {
      commonIssues: [
        ...
        },
        {
          ...
          technicalNote: 'Check app\'s URL scheme registration'
        }
      ]
    },
    preconditions: ['Have a valid deep link', 'App installed'],
    testData: 'Working deep link URL',
    automatable: false,
    status: 'Not Started',
    notes: ''
  },
  ...
  {
    id: 'TC-SPLASH-021',
    title: 'Image Cache Clears When Version Changes',
    ...
    testSteps: [
      {
        step: 1,
        instruction: 'Use app to cache some images',
        detailedSteps: [
      ...
      },
      {
        ...
        detailedSteps: [
          ...
          '2. Reopen the app',
          '3. During splash, cache should clear'
        ],
        whatYouShouldSee: 'Images may reload from server (brief loading)',
        expectedResult: 'Image cache cleared, fresh images loaded'
      }
    ],
    successChecklist: [
      ...
      commonIssues: [
        {
          ...
          whatToDo: 'Cache may not be clearing. Report as bug.',
          technicalNote: 'ensureImagesVersion() cache clear may fail'
        }
      ]
    },
