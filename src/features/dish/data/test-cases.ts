...
export const dishTestCases: TestCase[] = [
  ...
  },
  {
    ...
    testSteps: [
      ...
      {
        step: 5,
        instruction: 'Press the back button to test navigation',
        detailedSteps: [
        ...
        whatYouShouldSee: 'When you press back, the app navigates to the home screen (not crashing). This is normal because the app was opened from a link when it wasn\'t running, so it goes to home instead of trying to go "back" to a previous screen',
        expectedResult: 'Navigation works correctly - goes to home screen without crashing'
      }
    ],
    successChecklist: [
      ...
      '✓ Pressing back navigates to home screen (doesn\'t crash)',
  ...
  },
  {
    ...
    testSteps: [
      { step: 1, instruction: 'Navigate to home/trending section', expectedResult: 'Home feed displayed with dish cards' },
    ...
    testSteps: [
      {
        ...
        detailedSteps: [
          '1. Open the app and navigate to a restaurant menu',
  ...
  // ============================================
  {
    ...
    testSteps: [
      ...
      },
      {
        ...
        whatYouShouldSee: 'If everything is valid: The screen navigates to restaurant menu (if you came from home feed) or back to previous screen (if you came from restaurant menu). If restaurant is offline: A gray message appears at the bottom saying the restaurant is offline, but the dish will still be added to your cart',
        expectedResult: 'Button checks that all required options and toppings are selected, then adds the dish to cart, then navigates to the appropriate screen based on where you came from'
      },
      {
        step: 4,
  ...
  },
  {
    ...
    testSteps: [
      ...
      { step: 4, instruction: 'Tap "Edit Cart"', expectedResult: 'Cart item updated, navigate to cart' }
    ],
  ...
  // ============================================
  {
    ...
    testSteps: [
      ...
      },
      {
        ...
        detailedSteps: [
          '1. Navigate to your profile or favorites section (usually in the app menu)',
  ...
  // ============================================
  {
    ...
    testSteps: [
      ...
      { step: 3, instruction: 'Verify URL format', expectedResult: 'URL contains dish ID' },
  ...
  // ============================================
  {
    ...
    testSteps: [
      { step: 1, instruction: 'Navigate to dish with invalid ID', expectedResult: 'Error state displayed' },
      { step: 2, instruction: 'Verify error message', expectedResult: 'Appropriate error shown' },
      { step: 3, instruction: 'Try navigation options', expectedResult: 'Can navigate away' }
    ],
  ...
  {
    id: 'TC-DISH-028',
    title: 'Service Mode Add',
    type: 'Functional',
    priority: 'P2',
    relatedUseCases: ['UC-DISH-019'],
    relatedEdgeCases: ['EC-DISH-038', 'EC-DISH-039'],
    testSteps: [
      { step: 1, instruction: 'Open dish in service mode', expectedResult: 'Dish page with service context' },
      ...
      { step: 4, instruction: 'Verify cart shows service', expectedResult: 'Service item in cart' }
    ],
    preconditions: ['Service mode enabled'],
    automatable: true,
    status: 'Not Started',
    notes: ''
  },
  {
    ...
    testSteps: [
      ...
      { step: 3, instruction: 'Add to cart', expectedResult: 'Special navigation flow' },
  ...
  // ============================================
  {
    ...
    testSteps: [
      { step: 1, instruction: 'Open dish with broken image URL', expectedResult: 'Fallback image shown' },
    ...
    preconditions: ['Dish with invalid image URL'],
    automatable: true,
    status: 'Not Started',
    notes: ''
  },
  ...
  // ============================================
  {
    ...
    testSteps: [
      ...
      { step: 2, instruction: 'Tap report card', expectedResult: 'Navigate to report screen' },
  ...
  },
  {
    ...
    testSteps: [
      { step: 1, instruction: 'Tap restaurant logo in app bar', expectedResult: 'Navigate to restaurant menu' },
  ...
  },
  {
    ...
    whyItMatters: 'Sometimes people click shared links when the app isn\'t running. The app should launch smoothly and open directly to the dish, then handle navigation correctly when you press back.',
    estimatedTime: '3 minutes',
    type: 'Integration',
    priority: 'P1',
    relatedUseCases: ['UC-DISH-002'],
    ...
    testSteps: [
      ...
      },
      {
        ...
        whatYouShouldSee: 'When you press back, the app navigates to the home screen (not crashing). This is normal because the app was opened from a link when it wasn\'t running, so it goes to home instead of trying to go "back" to a previous screen',
        expectedResult: 'Navigation works correctly - goes to home screen without crashing or showing blank screen'
      }
    ],
    successChecklist: [
