  ...
  // ============================================
  {
    ...
    testSteps: [
      ...
      },
      {
        ...
        expectedResult: 'Navigation to order tracking, cart is cleared'
      }
    ],
    successChecklist: [
    ...
    testSteps: [
      {
        ...
        whatYouShouldSee: 'A rewards widget showing progress toward next reward tier.',
  ...
  },
  {
    ...
    testSteps: [
      ...
      },
      {
        ...
        expectedResult: 'Navigation blocked with message'
      }
    ],
    successChecklist: [
