...
function ActionNodeComponent({ id, data, selected }: NodeProps<FlowNodeData>) {
    ...
    >
      ...
      <div
        className={`
          ...
          overflow-hidden
          ${selected ? 'ring-4 ring-teal-300/50' : ''}
        `}
      ...
      >
        ...
        {/* Content */}
        <div 
          className="flex items-center justify-center relative z-10 px-3 max-w-full"
        ...
        >
          {isEditing ? (
            ...
            <span 
              ...
              style={{ maxWidth: `${baseWidth * scale * 0.8}px` }}
              title={label}
            >
              {label}
            </span>
